...
declare namespace ts.pxtc.Util {
    ...
    export function copySubcategoryStrings(apis: pxt.Map<string>): void;
...
declare namespace pxt.github {
    ...
    function normalizeRepoId(id: string, defaultTag?: string, ignoreCase?: boolean): string;
...
declare namespace pxt {
    class Package {
        ...
        loadConfig(skipSave?: boolean): void;
...
declare namespace ts.pxtc.service {
    ...
    interface HomeSearchOptions {
        term: string;
        entries: HomeSearchInfo[];
    }
    interface HomeSearchInfo {
        id: string;
        name: string;
        description?: string;
        tags?: string;
...
declare namespace pxt.tutorial {
    ...
    function mergeTutorialDependencies(projectDependencies: pxt.Map<string>, tutorialDependencies: pxt.Map<string>): pxt.Map<string>;
}
declare namespace ts.pxtc {
...
declare const addAriaHidden: (el: HTMLElement) => string;
declare namespace pxtmelody {
    class MelodyInfo {
        name: string;
        notes: string;
