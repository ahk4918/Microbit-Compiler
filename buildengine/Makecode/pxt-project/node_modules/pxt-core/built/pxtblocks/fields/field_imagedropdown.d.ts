...
export declare class FieldImageDropdown extends FieldDropdownGrid implements FieldCustom {
    protected savedPrimary_: string;
    constructor(text: string, options: FieldImageDropdownOptions, validator?: Function);
    protected setFocusedItem_(gridItemContainer: HTMLElement): void;
    protected createRow(rowIndex: number): HTMLDivElement;
    /**
